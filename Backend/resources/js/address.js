...
const searchPlace = addressTerm => {
    ...
    /* CREO UN SETTIMEOUT CON UN RITARDO DI 400MILLISECONDI CHE RICHIAMA LA FUNZIONE PER GESTIRE API DI GOOGLE MAPS PASSANDO COME PARAMENTRO L'INDRIZZO SCELTO DALL'UTENTE */
